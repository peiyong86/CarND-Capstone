...
class TLClassifier(object):
    ...
    def get_classification(self, image):
        ...
        if len(detect_boxes) == 0:
            rospy.loginfo("detect box num is 0.")
    ...
    def load_detector(self):
        ...
        with open('light_classification/models/ssd_mobilenet_v1_traffic_lights/frozen_inference_graph.pb', 'rb') as f:
            serialized = f.read()
    ...
    def load_classifier(self):
        ...
        with open('light_classification/models/classifier/frozen_graph.pb', 'rb') as f:
            serialized = f.read()
